...
**Codex:** Copy [`AGENTS.md`](AGENTS.md) into the repository root so Codex can discover it as project instructions.
...
- **Codex:** Use the root [`AGENTS.md`](AGENTS.md) file. Codex reads it as repository-level guidance when it starts in this repo.
